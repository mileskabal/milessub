    ...
    jPlayerPlaylist.prototype = {
        ...
        _refresh: function (a) {
            ...
            if (a && !b.isFunction(a)) b(this.cssSelector.playlist + " ul").empty(), b.each(this.playlist, function (a) {
                b(c.cssSelector.playlist + " ul").append(c._createListItem(c.playlist[a],a))
            }), this._updateControls();
            else {
                var d = b(this.cssSelector.playlist + " ul").children().length ? this.options.playlistOptions.displayTime : 0;
                // b(this.cssSelector.playlist + " ul").slideUp(d, function () {
                b(this.cssSelector.playlist + " ul").show(d, function () {
                    var d = b(this);
                    b(this).empty();
                    b.each(c.playlist, function (a) {
                        d.append(c._createListItem(c.playlist[a],a))
                    });
                    c._updateControls();
                    b.isFunction(a) && a();
        ...
        _createListItem: function (a,i) {
            ...
            d += '<a href="javascript:;" class="' + this.options.playlistOptions.itemClass + '" data-index="'+i+'" tabindex="1" data-title="'+a.title+' - '+a.artist+'" title="'+a.title+' - '+a.artist+'">' + a.title + 
			// (a.artist ? " <span class='jp-artist'>by " + a.artist + "</span>" : "") +
			"</a>";
            d += "</div></li>";
            return d
        },
